...
Bite 104. Split and join
    ...
    using a '|' (pipe).
    So Hello world:\nI am coding in Python :)\nHow awesome! would turn into: Hello world:|I am coding in
    Python :)|How awesome!
    ...
    Also note that, although we wanted you to learn about split and join here, there are more ways to pull this one
    off (check out the forum upon resolving this Bite ...)
"""
...
def split_in_columns(message=message):
    ...
    separator = '|'
    new_message = separator.join(message)
    return new_message
